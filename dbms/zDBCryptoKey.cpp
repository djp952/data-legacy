...
//---------------------------------------------------------------------------
// zDBCryptoKey Constructor
//
// Arguments:
//
//	password		- The password to be hashed into an encryption key

zDBCryptoKey::zDBCryptoKey(SecureString^ password)
{
...
//---------------------------------------------------------------------------
// zDBCryptoKey Finalizer

zDBCryptoKey::!zDBCryptoKey()
{
...
//---------------------------------------------------------------------------
// zDBCryptoKey::CreatePrivateExponentOneKey (static, private)
//
...
BOOL zDBCryptoKey::CreatePrivateExponentOneKey(LPCTSTR szProvider, DWORD dwProvType, 
...
//---------------------------------------------------------------------------
// zDBCryptoKey::ImportPlainSessionBlob (static, private)
//
...
BOOL zDBCryptoKey::ImportPlainSessionBlob(HCRYPTPROV hProv, HCRYPTKEY hPrivateKey, 
