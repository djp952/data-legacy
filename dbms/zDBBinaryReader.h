...
#ifndef __ZDBBINARYREADER_H_
#define __ZDBBINARYREADER_H_
#pragma once
...
//---------------------------------------------------------------------------
// Class zDBBinaryReader
//
// zDBBinaryReader is the data type returned from the zDBDataReader's GetValue()
...
public ref class zDBBinaryReader sealed : public IConvertible, public ITrackableObject
{
public:
	...
	static explicit operator bool					(zDBBinaryReader^ rhs) { return rhs->ToBoolean(); }
	static explicit operator System::Byte			(zDBBinaryReader^ rhs) { return rhs->ToByte(); }
	static explicit operator array<System::Byte>^	(zDBBinaryReader^ rhs) { return rhs->ToBytes(); }
	static explicit operator __wchar_t				(zDBBinaryReader^ rhs) { return rhs->ToChar(); }
	static explicit operator array<Char>^			(zDBBinaryReader^ rhs) { return rhs->ToChars(); }
	static explicit operator DateTime				(zDBBinaryReader^ rhs) { return rhs->ToDateTime(); }
	static explicit operator double					(zDBBinaryReader^ rhs) { return rhs->ToDouble(); }
	static explicit operator Guid					(zDBBinaryReader^ rhs) { return rhs->ToGuid(); }
	static explicit operator short					(zDBBinaryReader^ rhs) { return rhs->ToInt16(); }
	static explicit operator int					(zDBBinaryReader^ rhs) { return rhs->ToInt32(); }
	static explicit operator __int64				(zDBBinaryReader^ rhs) { return rhs->ToInt64(); }
	static explicit operator SByte					(zDBBinaryReader^ rhs) { return rhs->ToSByte(); }
	static explicit operator float					(zDBBinaryReader^ rhs) { return rhs->ToSingle(); }
	static explicit operator String^				(zDBBinaryReader^ rhs) { return rhs->ToString(); }
	static explicit operator unsigned short			(zDBBinaryReader^ rhs) { return rhs->ToUInt16(); }
	static explicit operator unsigned int			(zDBBinaryReader^ rhs) { return rhs->ToUInt32(); }
	static explicit operator unsigned __int64		(zDBBinaryReader^ rhs) { return rhs->ToUInt64(); }
...
internal:
	...
	zDBBinaryReader(StatementHandle* pStatement, int nOrdinal);
...
private:
	...
	~zDBBinaryReader() { this->!zDBBinaryReader(); m_disposed = true; }
	!zDBBinaryReader();
	...
	literal String^ BINARY_DATA_STRING = "zDBBinaryReader({0})";
