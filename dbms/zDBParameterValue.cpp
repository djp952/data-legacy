//---------------------------------------------------------------------------
// zDBParameterValue Implementation
//
...
#include "zDBParameterValue.h"		// Include zDBParameterValue declarations
...
typedef struct {
	...
	zDBType		providerDbType;			// Best zDBType value
...
TYPECODE_MAP_ENTRY g_typeCodeMap[] = { 
	...
	{ TypeCode::Empty,		zDBType::Null,		DbType::Object },		// 0
	{ TypeCode::Object,		zDBType::String,	DbType::String },		// 1
	{ TypeCode::DBNull,		zDBType::Null,		DbType::Object },		// 2
	{ TypeCode::Boolean,	zDBType::Boolean,	DbType::Boolean },		// 3
	{ TypeCode::Char,		zDBType::String,	DbType::String },		// 4
	{ TypeCode::SByte,		zDBType::Integer,	DbType::SByte },		// 5
	{ TypeCode::Byte,		zDBType::Integer,	DbType::Byte },			// 6
	{ TypeCode::Int16,		zDBType::Integer,	DbType::Int16 },		// 7
	{ TypeCode::UInt16,		zDBType::Integer,	DbType::UInt16 },		// 8
	{ TypeCode::Int32,		zDBType::Integer,	DbType::Int32 },		// 9
	{ TypeCode::UInt32,		zDBType::Integer,	DbType::UInt32 },		// 10
	{ TypeCode::Int64,		zDBType::Long,		DbType::Int64 },		// 11
	{ TypeCode::UInt64,		zDBType::Long,		DbType::UInt64 },		// 12
	{ TypeCode::Single,		zDBType::Float,		DbType::Single },		// 13
	{ TypeCode::Double,		zDBType::Float,		DbType::Double },		// 14
	{ TypeCode::Decimal,	zDBType::Float,		DbType::Decimal },		// 15
	{ TypeCode::DateTime,	zDBType::DateTime,	DbType::DateTime },		// 16
	{ (TypeCode)17,			zDBType::Null,		DbType::Object },		// 17 (unused)
	{ TypeCode::String,		zDBType::String,	DbType::String },		// 18
};

//---------------------------------------------------------------------------
// zDBParameterValue::ByteArrayToDouble (private, static)
//
...
double zDBParameterValue::ByteArrayToDouble(array<System::Byte>^ value)
{
...
//---------------------------------------------------------------------------
// zDBParameterValue::ByteArrayToInt32 (private, static)
//
...
int zDBParameterValue::ByteArrayToInt32(array<System::Byte>^ value)
{
	Debug::Assert(value != nullptr);
...
int zDBParameterValue::Size::get(void)
{
...
array<System::Byte>^ zDBParameterValue::ToBinary(void)
{
...
bool zDBParameterValue::ToBoolean(void)
{
...
DateTime zDBParameterValue::ToDateTime(void)
{
...
double zDBParameterValue::ToFloat(void)
{
...
Guid zDBParameterValue::ToGuid(void)
{
...
int zDBParameterValue::ToInteger(void)
{
...
__int64 zDBParameterValue::ToLong(void)
{
...
String^ zDBParameterValue::ToString(void)
{
...
void zDBParameterValue::Value::set(Object^ value)
{
	...
	// not in this list, it will left at zDBType::String and DbType::String

	// GUID   --> zDBType::Guid; DbType::Guid
	else if(m_type == Guid::typeid) {

		m_providerDbType = zDBType::Guid;
		m_genericDbType = Data::DbType::Guid;
	}

	// BYTE[] --> zDBType::Binary; DbType::Binary
	if(m_type == array<System::Byte>::typeid) { 

		m_providerDbType = zDBType::Binary;
		m_genericDbType = Data::DbType::Binary;
	}

	// CHAR[] --> zDBType::String; DbType::StringFixedLength
	else if(m_type == array<Char>::typeid) {

		m_providerDbType = zDBType::String;
