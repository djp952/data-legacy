...
#ifndef __ZDBARGUMENT_H_
#define __ZDBARGUMENT_H_
#pragma once
...
// Class zDBArgument
//
// zDBArgument is used to provide a wrapper around function arguments as well
...
public ref class zDBArgument sealed : public IConvertible, public ITrackableObject
{
public:
	...
	static explicit operator bool					(zDBArgument^ rhs) { return rhs->ToBoolean(); }
	static explicit operator System::Byte			(zDBArgument^ rhs) { return rhs->ToByte(); }
	static explicit operator array<System::Byte>^	(zDBArgument^ rhs) { return rhs->ToBytes(); }
	static explicit operator __wchar_t				(zDBArgument^ rhs) { return rhs->ToChar(); }
	static explicit operator array<Char>^			(zDBArgument^ rhs) { return rhs->ToChars(); }
	static explicit operator DateTime				(zDBArgument^ rhs) { return rhs->ToDateTime(); }
	static explicit operator double					(zDBArgument^ rhs) { return rhs->ToDouble(); }
	static explicit operator Guid					(zDBArgument^ rhs) { return rhs->ToGuid(); }
	static explicit operator short					(zDBArgument^ rhs) { return rhs->ToInt16(); }
	static explicit operator int					(zDBArgument^ rhs) { return rhs->ToInt32(); }
	static explicit operator __int64				(zDBArgument^ rhs) { return rhs->ToInt64(); }
	static explicit operator SByte					(zDBArgument^ rhs) { return rhs->ToSByte(); }
	static explicit operator float					(zDBArgument^ rhs) { return rhs->ToSingle(); }
	static explicit operator String^				(zDBArgument^ rhs) { return rhs->ToString(); }
	static explicit operator unsigned short			(zDBArgument^ rhs) { return rhs->ToUInt16(); }
	static explicit operator unsigned int			(zDBArgument^ rhs) { return rhs->ToUInt32(); }
	static explicit operator unsigned __int64		(zDBArgument^ rhs) { return rhs->ToUInt64(); }
...
internal:
	...
	zDBArgument(sqlite3_value* value) : m_value(value), 
	...
	// Handle
	//
	// Exposes the internal sqlite3_value handle, since zDBResult can take
...
private:
	...
	// DESTRUCTOR
	~zDBArgument() { m_value = NULL; m_disposed = true; }
