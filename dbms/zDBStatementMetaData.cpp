//---------------------------------------------------------------------------
// zDBStatementMetaData Implementation
//
...
#include "zDBStatementMetaData.h"	// Include zDBStatementMetaData declarations
...
//---------------------------------------------------------------------------
// zDBStatementMetaData Constructor
//
// Arguments:
//
//	pStatement		- Pointer to the wrapped SQLite statement handle

zDBStatementMetaData::zDBStatementMetaData(StatementHandle* pStatement) :
...
//---------------------------------------------------------------------------
// zDBStatementMetaData Finalizer

zDBStatementMetaData::!zDBStatementMetaData()
{
...
//---------------------------------------------------------------------------
// zDBStatementMetaData::AddSchemaTableRow (private)
//
...
void zDBStatementMetaData::AddSchemaTableRow(DataTable^ schema, int ordinal)
{
	...
	if(nResult == SQLITE_OK) {
		...
		row["DataTypeName"]								= zDBUtil::FastPtrToStringAnsi(pszColumnDataType);
		...
		//
		// TODO: IsUnique needs stuff from zDBSchemaInfo
	}
...
//---------------------------------------------------------------------------
// zDBStatementMetaData::BuildSchemaTable
//
...
DataTable^ zDBStatementMetaData::BuildSchemaTable(void)
{
...
//---------------------------------------------------------------------------
// zDBStatementMetaData::CacheFieldTypes (private)
//
...
void zDBStatementMetaData::CacheFieldTypes(int ordinal)
{
...
//---------------------------------------------------------------------------
// zDBStatementMetaData::FieldCount::get
//
// Gets the number of fields defined in the statement metadata

int zDBStatementMetaData::FieldCount::get(void)
{
...
//---------------------------------------------------------------------------
// zDBStatementMetaData::GetCatalogName
//
...
String^ zDBStatementMetaData::GetCatalogName(int ordinal)
{
	CHECK_DISPOSED(m_disposed);
...
//---------------------------------------------------------------------------
// zDBStatementMetaData::GetDataTypeName
//
...
String^ zDBStatementMetaData::GetDataTypeName(int ordinal)
{
	CHECK_DISPOSED(m_disposed);
	if((ordinal < 0) || (ordinal >= m_fields)) throw gcnew ArgumentOutOfRangeException();
...
//---------------------------------------------------------------------------
// zDBStatementMetaData::GetFieldType
//
...
Type^ zDBStatementMetaData::GetFieldType(int ordinal)
{
	CHECK_DISPOSED(m_disposed);
	if((ordinal < 0) || (ordinal >= m_fields)) throw gcnew ArgumentOutOfRangeException();
...
String^ zDBStatementMetaData::GetName(int ordinal)
{
	CHECK_DISPOSED(m_disposed);
	if((ordinal < 0) || (ordinal >= m_fields)) throw gcnew ArgumentOutOfRangeException();
...
//---------------------------------------------------------------------------
// zDBStatementMetaData::GetProviderSpecificDbType
//
...
zDBType zDBStatementMetaData::GetProviderSpecificDbType(int ordinal)
{
	CHECK_DISPOSED(m_disposed);
	if((ordinal < 0) || (ordinal >= m_fields)) throw gcnew ArgumentOutOfRangeException();

	return zDBType::FromType(GetProviderSpecificFieldType(ordinal));
}

//---------------------------------------------------------------------------
// zDBStatementMetaData::GetProviderSpecificFieldType
//
...
Type^ zDBStatementMetaData::GetProviderSpecificFieldType(int ordinal)
{
	CHECK_DISPOSED(m_disposed);
	if((ordinal < 0) || (ordinal >= m_fields)) throw gcnew ArgumentOutOfRangeException();
...
//---------------------------------------------------------------------------
// zDBStatementMetaData::GetSchemaName
//
...
String^ zDBStatementMetaData::GetSchemaName(int ordinal)
{
	CHECK_DISPOSED(m_disposed);
	if((ordinal < 0) || (ordinal >= m_fields)) throw gcnew ArgumentOutOfRangeException();
...
//---------------------------------------------------------------------------
// zDBStatementMetaData::GetTableName
//
...
String^ zDBStatementMetaData::GetTableName(int ordinal)
{
	CHECK_DISPOSED(m_disposed);
	if((ordinal < 0) || (ordinal >= m_fields)) throw gcnew ArgumentOutOfRangeException();
...
//---------------------------------------------------------------------------
// zDBStatementMetaData::StaticConstruct (private, static)
//
...
void zDBStatementMetaData::StaticConstruct(void)
{
	//
